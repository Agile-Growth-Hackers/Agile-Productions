      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="md:hidden grid grid-cols-3 gap-4">
          {mobileClients.map((client) => (
            <div
              key={client.name}
              className="flex items-center justify-center bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-3 hover:scale-105 w-full h-20"
            >
              <img
                src={client.logo}
                alt={client.name}
        ...
        <div className="hidden md:grid lg:hidden grid-cols-4 gap-5">
          {tabletClients.map((client) => (
            <div
              key={client.name}
              className="flex items-center justify-center bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-4 hover:scale-105 w-full h-24"
            >
              <img
                src={client.logo}
                alt={client.name}
        ...
        <div className="hidden lg:grid grid-cols-6 gap-6">
          {desktopClients.map((client) => (
            <div
              key={client.name}
              className="flex items-center justify-center bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6 hover:scale-105 w-full h-28"
            >
              <img
                src={client.logo}
                alt={client.name}
